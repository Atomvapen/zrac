...
pub const Menu = struct {
    ...
    pub fn drawMenuSST(self: *Menu, riskProfile: *risk.RiskArea) void {
        ...
        //TODO fixa
        const validNames = risk.amm.getValidNames(riskProfile.weaponType);
        if (rg.guiDropdownBox(.{ .x = 50, .y = barHeight + 355, .width = 140, .height = 30 }, validNames, &gui.ammunitionType.value, gui.ammunitionType.editMode) != 0) gui.ammunitionType.editMode = !gui.ammunitionType.editMode;
