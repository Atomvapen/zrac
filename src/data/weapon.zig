...
pub const Model = struct {
    ...
    pub const KSP58: Model = Model{ .v_still = 200.0, .v_moveable = 300.0, .id = 2 };
    pub const KSP58MBS: Model = Model{ .v_still = 100.0, .v_moveable = 200.0, .id = 3 };
    pub const KSP58MMLVS: Model = Model{ .v_still = 100.0, .v_moveable = 200.0, .id = 4 };
    pub const KSP90: Model = Model{ .v_still = 100.0, .v_moveable = 200.0, .id = 5 };
    pub const KSP90MBS: Model = Model{ .v_still = 100.0, .v_moveable = 200.0, .id = 6 };
